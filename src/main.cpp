      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          std::vector<double> ptsx_vehicle(n_pts);
          std::vector<double> ptsy_vehicle(n_pts);
          ...
          Eigen::Map<Eigen::VectorXd> ptsx_transform(&ptsx_vehicle[0], n_pts);
          Eigen::Map<Eigen::VectorXd> ptsy_transform(&ptsy_vehicle[0], n_pts);

          auto coeffs = polyfit(ptsx_transform, ptsy_transform, 3);

          // Current states in vehicle's coordinate system
          double x0 = 0.0;
          double y0 = 0.0;
          double psi0 = 0.0;
          double v0 = v;
